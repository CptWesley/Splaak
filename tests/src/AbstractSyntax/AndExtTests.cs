...
namespace Splaak.Tests.AbstractSyntax
{
    public class AndExtTests
    {
        ...
        {
            Assert.True(_obj.Equals(new AndExt(_1, _2)));
        }
        ...
        {
            Assert.False(_obj.Equals(new AndExt(_1, _1)));
        }
        ...
        {
            Assert.Equal(_obj.GetHashCode(), new AndExt(_1, _2).GetHashCode());
        }

        [Fact]
        public void ToStringTest()
        {
            Assert.Equal(_obj.ToString(), "AndExt(" + _1 + ", " + _2 + ")");
        }

        [Fact]
        public void DesugarTest()
        {
            Assert.Equal(_obj.Desugar(), new IfC(_1.Desugar(), _2.Desugar(), new BoolC(false)));
        }
    }
}
