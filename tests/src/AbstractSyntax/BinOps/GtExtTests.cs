...
namespace Splaak.Tests.AbstractSyntax.BinOps
{
    public class GtExtTests
    {
        ...
        {
            Assert.True(_obj.Equals(new GtExt(_1, _2)));
        }
        ...
        {
            Assert.False(_obj.Equals(new GtExt(_1, _1)));
        }
        ...
        {
            Assert.Equal(_obj.GetHashCode(), new GtExt(_1, _2).GetHashCode());
        }

        [Fact]
        public void ToStringTest()
        {
            Assert.Equal(_obj.ToString(), "GtExt(" + _1 + ", " + _2 + ")");
        }
        ...
        public void DesugarTest()
        {
            Assert.Equal(_obj.Desugar(),
                ...
                new BoolC(false), new IfC(new EqC(_1.Desugar(), _2.Desugar()),
                new BoolC(false), new BoolC(true))));
        }
    }
}
