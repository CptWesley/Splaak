...
namespace Splaak.Tests.AbstractSyntax.BinOps
{
    public class GeqExtTests
    {
        ...
        {
            Assert.True(_obj.Equals(new GeqExt(_1, _2)));
        }
        ...
        {
            Assert.False(_obj.Equals(new GeqExt(_1, _1)));
        }
        ...
        {
            Assert.Equal(_obj.GetHashCode(), new GeqExt(_1, _2).GetHashCode());
        }

        [Fact]
        public void ToStringTest()
        {
            Assert.Equal(_obj.ToString(), "GeqExt(" + _1 + ", " + _2 + ")");
        }
